...
func _reset_button_pressed() -> void:
    ...
    are_you_sure.dialog_text = "Are you sure you want to force sync? This will overwrite any animations that share the same name from the source AnimationPlayer."
...
func sync(force:bool=false) -> void:
    ...
    # TODO:
    # - Create new animations in this AnimationPlayer that copy the names and lengths of the animations in source_animation_player
    # - Create new tracks that are animation player tracks that put the animation from source_animation_player into this AnimationPlayer
    # - Ignore animations that already exist in this AnimationPlayer
